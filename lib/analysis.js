...
// some varaibles and function definations : by hu
...
// main logic, define the properties of J$ : by hu
...
// read input, if we know the type of input, use corresponding function (like readString), by: hu
            sandbox.readInput = () => {
            ...
            const solver = process.env.SOLVER || 'G-Strings';
            if (solver.indexOf(',') === -1) {
// clog store the file name of smt2 to be solved 
...
//write input to file inputLog; each step the inputLog will be updated. by: hu
                            ...
                            try {
                              ...
                              if (e instanceof TypeError) {
                                ...
                                //        as type constraints?
// below is the logic for string solve G-String, so annotate it. by : hu
...
// function for jalangi main-entrypoint $cb$, by : hu
        onReady(cb) {
