...
// this is the function to write the smt file of SMT solver
            ...
            if (expr instanceof Variable) {
                if (!this._declaredVariables.has(expr.name)) {
                    ...
                    if (this.solver.isCPSolver()) {
                        ...
                        // huzi add
                        this.solver.declareConst(expr.name, "String");
...
//            console.dir(constraints, {depth: null});
    ...
    async _generateInput() {
        ...
        let result;
// generate input of smt solver, by : hu
