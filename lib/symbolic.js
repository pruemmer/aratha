...
class GetField extends ObjectOp {
    ...
    toFormula() {
        ...
        if(this.base.regex){
            ...
            return ["Str", ["(_ str.extract "+this.offset.value+")",
        ...
        if(_.isRegExp(searchRegex)){
            ...
            if(searchRegex.global){
                ...
                if(isRf){
                    ...
                    const regexFormula = RegExpParser.parse(searchRegex.source);
                    return ["str.replaceallre", this.base.toStringFormula(), regexFormula.toRegexFormula(), repString];    
                }
            }else{
                const isRf = /\$\d+/.test(repString);
                if(isRf){
                    ...
                    return ["str.replacere", this.base.toStringFormula(), regexFormula.toRegexFormula(), this.replacement.toStringFormula()];    
            }
        }else{
